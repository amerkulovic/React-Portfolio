...
import myMovieSpace from "../../images/mymoviespace2.0.png";
  ...
  return (
    <section id="portfolio" className="bg-[#DAD9D5] p-10">
      ...
      <div className="flex flex-wrap justify-center">
        <Project link="https://my-movie-space-9d82abf6cb80.herokuapp.com/" imgLink={myMovieSpace} githubLink="https://github.com/amerkulovic/MyMovieSpace2" projectTitle="MyMovieSpace" />
