  ...
  return (
    <section className="bg-[#DAD9D5] p-10">
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <Project link="https://www.youtube.com/watch?v=QZSxZ1aRiGQ" imgLink={socialNetwork} githubLink="https://github.com/amerkulovic/Social-Network-API" projectTitle="Social Network API" />
